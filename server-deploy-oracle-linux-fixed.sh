...
# Cloudedze Server Deployment Script for Oracle Linux/RHEL (Fixed)
...
print_info "Removing conflicting Node.js packages..."
sudo yum remove -y nodejs npm || true

# Install required system packages (excluding nodejs and npm)
print_info "Installing system dependencies..."
sudo yum install -y curl wget git nginx postgresql-server postgresql-contrib python3 python3-pip gcc gcc-c++ make
